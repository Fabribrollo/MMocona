...
<body>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="item-equipamiento"><img src="../img/transporte.svg" class="img-equipamiento"><span class="p-suites" id="main-medio-transporte-1">Medio de Transporte:
                                    </span><span class="p-bold-excursiones" id="main-vehiculo-4x4">Vehículo 4x4</span></div>
                            </div>
                        </div>
                                ...
                                <div class="splide" id="splideSafariDiv" aria-label="Splide Basic">
                                    <div class="splide__track">
                                        <div class="splide__list" id="splideSafari">
                                            <a class="splide__slide" href="../img/safari_01.webp">
                                                <img class="img-master-suite" src="../img/safari_01.webp" loading="lazy">
                                            </a>
                                            <a class="splide__slide" href="../img/safari_02.webp">
                                                <img class="img-master-suite" src="../img/safari_02.webp" loading="lazy">
                                            </a>
                                            <a class="splide__slide" href="../img/safari_03.webp">
                                                <img class="img-master-suite" src="../img/safari_03.webp" loading="lazy">
                                            </a>
                                            <a class="splide__slide" href="../img/safari_04.webp">
                                                <img class="img-master-suite" src="../img/safari_04.webp" loading="lazy">
                                            </a>
                                            <a class="splide__slide" href="../img/safari_05.webp">
                                                <img class="img-master-suite" src="../img/safari_05.webp" loading="lazy">
                                            </a>
                                            <a class="splide__slide" href="../img/safari_06.webp">
                                                <img class="img-master-suite" src="../img/safari_06.webp" loading="lazy">
                                            </a>
                                            <a class="splide__slide" href="../img/safari_07.webp">
                                                <img class="img-master-suite" src="../img/safari_07.webp" loading="lazy">
                                            </a>
                                            <a class="splide__slide" href="../img/safari_08.webp">
                                                <img class="img-master-suite" src="../img/safari_08.webp" loading="lazy">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="carouselSafari" class="carousel slide">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img src="../img/safari1.webp" class="d-block w-100" alt="..." loading="lazy">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="../img/safari2.webp" class="d-block w-100" alt="..." loading="lazy">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="../img/safari3.webp" class="d-block w-100" alt="..." loading="lazy">
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="item-equipamiento"><img src="../img/transporte.svg" class="img-equipamiento"><span class="p-suites" id="main-medio-transporte-3">Medio de Transporte:
                                    </span><span class="p-bold-excursiones" id="main-vehiculo-4x4-gomon">Gomón + Vehículo 4x4</span></div>
                            </div>
                        </div>
                        <div class="row row-img-master-suite desktop767">
                            <div class="col-12">
                                <div class="splide" id="splideFloatingDiv" aria-label="Splide Basic">
                                    <div class="splide__track">
                                        <div class="splide__list" id="splideFloating">
                                            <a class="splide__slide" href="../img/floating_01.webp">
                                                <img class="img-master-suite" src="../img/floating_01.webp" loading="lazy">
                                            </a>
                                            <a class="splide__slide" href="../img/floating_02.webp">
                                                <img class="img-master-suite" src="../img/floating_02.webp" loading="lazy">
                                            </a>
                                            <a class="splide__slide" href="../img/floating_03.webp">
                                                <img class="img-master-suite" src="../img/floating_03.webp" loading="lazy">
                                            </a>
                                            <a class="splide__slide" href="../img/floating_04.webp">
                                                <img class="img-master-suite" src="../img/floating_04.webp" loading="lazy">
                                            </a>
                                            <a class="splide__slide" href="../img/floating_05.webp">
                                                <img class="img-master-suite" src="../img/floating_05.webp" loading="lazy">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row row-img-master-suite mobile767">
                            <div class="col-12">
                                <div id="carouselFloating" class="carousel slide">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img src="../img/floating1.webp" class="d-block w-100" alt="..." loading="lazy">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="../img/floating2.webp" class="d-block w-100" alt="..." loading="lazy">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="../img/floating3.webp" class="d-block w-100" alt="..." loading="lazy">
                                        </div>
                                    </div>
                                ...
                                <div class="splide" id="splideCabalgataDiv" aria-label="Splide Basic HTML Example">
                                    <div class="splide__track">
                                        <div class="splide__list" id="splideCabalgata">
                                            <a class="splide__slide" href="../img/cabalgatas_01.webp">
                                                <img class="img-master-suite" src="../img/cabalgatas_01.webp" loading="lazy">
                                            </a>
                                            <a class="splide__slide" href="../img/cabalgatas_02.webp">
                                                <img class="img-master-suite" src="../img/cabalgatas_02.webp" loading="lazy">
                                            </a>
                                            <a class="splide__slide" href="../img/cabalgatas_03.webp">
                                                <img class="img-master-suite" src="../img/cabalgatas_03.webp" loading="lazy">
                                            </a>
                                            <a class="splide__slide" href="../img/cabalgatas_04.webp">
                                                <img class="img-master-suite" src="../img/cabalgatas_04.webp" loading="lazy">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row row-img-master-suite mobile767">
                            <div class="col-12">
                                <div id="carouselCabalgata" class="carousel slide">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img src="../img/cabalgata1.webp" class="d-block w-100" alt="..." loading="lazy">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="../img/cabalgata2.webp" class="d-block w-100" alt="..." loading="lazy">
                                        </div>
                                        <div class="carousel-item">
                                ...
                                <div class="splide" id="splideAvesDiv" aria-label="Splide Basic HTML Example">
                                    <div class="splide__track">
                                        <div class="splide__list" id="splideAves">
                                            <a class="splide__slide" href="../img/aves1.webp">
                                                <img class="img-master-suite" src="../img/aves1.webp" loading="lazy">
                                            </a>
                                            <a class="splide__slide" href="../img/aves2.webp">
                                                <img class="img-master-suite" src="../img/aves2.webp" loading="lazy">
                                            </a>
                                            <a class="splide__slide" href="../img/aves3.webp">
                                                <img class="img-master-suite" src="../img/aves3.webp" loading="lazy">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row row-img-master-suite mobile767">
                            <div class="col-12">
                                <div id="carouselAves" class="carousel slide">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img src="../img/aves1.webp" class="d-block w-100" alt="..." loading="lazy">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="../img/aves2.webp" class="d-block w-100" alt="..." loading="lazy">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="../img/aves3.webp" class="d-block w-100" alt="..." loading="lazy">
                                        </div>
                                    </div>
                                ...
                                <div class="splide" id="splideSenderoDiv" aria-label="Splide Basic">
                                    <div class="splide__track">
                                        <div class="splide__list" id="splideSendero">
                                            <a class="splide__slide" href="../img/sendero1.webp">
                                                <img class="img-master-suite" src="../img/sendero1.webp" loading="lazy">
                                            </a>
                                            <a class="splide__slide" href="../img/sendero2.webp">
                                                <img class="img-master-suite" src="../img/sendero2.webp" loading="lazy">
                                            </a>
                                            <a class="splide__slide" href="../img/sendero3.webp">
                                                <img class="img-master-suite" src="../img/sendero3.webp" loading="lazy">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row row-img-master-suite mobile767">
                            <div class="col-12">
                                <div id="carouselSenderos" class="carousel slide">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img src="../img/sendero1.webp" class="d-block w-100" alt="..." loading="lazy">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="../img/sendero2.webp" class="d-block w-100" alt="..." loading="lazy">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="../img/sendero3.webp" class="d-block w-100" alt="..." loading="lazy">
                                        </div>
                                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var splide3 = new Splide('#splideFloatingDiv', {
                perPage: 3,
                perMove: 1,
                gap: '10px',
                pagination: false,
            ...
            var splide6 = new Splide('#splideCabalgataDiv', {
                perPage: 3,
                perMove: 1,
                gap: '10px',
                pagination: false,
            ...
            var splide7 = new Splide('#splideAvesDiv', {
                perPage: 3,
                perMove: 1,
                gap: '10px',
                pagination: false,
            ...
            var splide8 = new Splide('#splideSenderoDiv', {
                perPage: 3,
                perMove: 1,
                gap: '10px',
                pagination: false,
