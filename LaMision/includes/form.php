...
// Luis todo: le saqué el ''container-fluid''al form-reserva container-fluid en la linea 8.

function formPrint($extraClass = "", $imgLink = "'../img/", $pagesLink = "'")
{
    echo "<div class='col-xl-5 $extraClass'>
            <form action='https://www.hoteladmin.com.ar/system/responsive/plugged-apps/book-vertical.php?hotelID=334&action=query_externo' target='_blank' method='post' class='form-reserva'>
                <div class='row'>
                    ...
                    <button type='submit' class='btn btn-primary btn-form-reservar' id='form-btn-reservar'>Reservar</button>
                </div>
            </form>
        </div>";
}
