                ...
                <div class='d-flex justify-content-around desktop'>
                    <div>
                        <ul class='menu-footer'>
                            <li><a href={$indexLink}index.php' id='footer-el-complejo'>El Complejo</a></li>
                            <li><a href={$externLink}LodgeDeSelva/index.php' >Lodge de Selva</a></li>
                            <li><a href={$externLink}LuxuryGlamping/index.php'>Glamping La reserva</a></li>
                ...
                <div class='container-fluid mobile'>
                    <div class='row'>
                        <div class='col-5 text-end'>
                            <a href={$indexLink}index.php' id='footer-el-complejo-2'>El Complejo</a>
                        </div>
                        <div class='col-7 text-center'>
                            <a href={$externLink}LodgeDeSelva/index.php'>Lodge de Selva</a>
                        </div>
                        <div class='col-6 text-end'>
                            <a href={$externLink}LuxuryGlamping/index.php'>Glamping La reserva</a>
                        </div>
                        <div class='col-6 text-center'>
                            <a href={$pagesLink}excursiones.php' id='footer-actividades-2'>Actividades</a>
                        </div>
                        <div class='col-5 text-end'>
        ...
        <div class='row second-row-footer'>
            <div class='col-12 col-sm-10 col-md-8 col-lg-6'>
                <div class='d-flex justify-content-between div-second-links-footer'>
                    <a href={$indexLink}index.php' class='link-footer linkPoliticas' id='footer-sitio-web-complejo'>Sitio Web del Complejo</a>
                    <a href={$externLink}LodgeDeSelva/index.php' class='link-footer linkTerminos' id='footer-sitio-web-lodge'>Sitio web del Lodge</a>
            ...
            <div class='col-2 col-md-4 col-lg-6 text-end screen-lg-md'>
               <a href='https://instagram.com/lamision.mocona' target='_blank'><img src={$imgLink}instagram.svg' /></a>
            </div>
        </div>
    </div>
</footer>";
