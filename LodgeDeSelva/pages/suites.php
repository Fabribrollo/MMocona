...
<head>
    ...
    <title>Suites - Lodge de Selva</title>
...
<p class='p-header' id='header-p-suites-habitaciones-planificadas'>Todas las habitaciones fueron planificadas para dos personas y se pueden adaptar
    en triples y
    cuádruples</p>";
    $rutaImagen = "'../img/suiteHeader.png'";
    $classFlor = "";
                                ...
                                <div class="splide" id="splideMasterSuiteDiv" aria-label="Splide Basic">
                                    <div class="splide__track">
                                        <div class="splide__list" id="splideMasterSuite">
                                            <a class="splide__slide" href="../img/masterSuite.png">
                                                <img class="img-master-suite" src="../img/masterSuite.png">
                                            </a>
                                            <a class="splide__slide" href="../img/masterSuiteDormitorio.png">
                                                <img class="img-master-suite" src="../img/masterSuiteDormitorio.png">
                                            </a>
                                            <a class="splide__slide" href="../img/masterSuiteBano.png">
                                                <img class="img-master-suite" src="../img/masterSuiteBano.png">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="carouselMasterSuite" class="carousel slide">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img src="../img/masterSuite.png" class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="../img/masterSuiteDormitorio.png" class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="../img/masterSuiteBaño.png" class="d-block w-100" alt="...">
                                        </div>
                                    </div>
                                ...
                                <div class="splide" id="splideSuiteSelvaDiv" aria-label="Splide Basic">
                                    <div class="splide__track">
                                        <div class="splide__list" id="splideSuiteSelva">
                                            <a class="splide__slide" href="../img/suiteSelvaFrente.png">
                                                <img class="img-master-suite" src="../img/suiteSelvaFrente.png">
                                            </a>
                                            <a class="splide__slide" href="../img/suiteSelvaCama.png">
                                                <img class="img-master-suite" src="../img/suiteSelvaCama.png">
                                            </a>
                                            <a class="splide__slide" href="../img/suiteSelvaDormitorio.png">
                                                <img class="img-master-suite" src="../img/suiteSelvaDormitorio.png">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row row-img-master-suite mobile767">
                            <div class="col-12">
                                <div id="carouselSuiteSelva" class="carousel slide">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img src="../img/suiteSelvaFrente.png" class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="../img/suiteSelvaCama.png" class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="../img/suiteSelvaDormitorio.png" class="d-block w-100" alt="...">
                                        </div>
                                    </div>
                                ...
                                <div class="splide" id="splideGranSuiteDiv" aria-label="Splide Basic">
                                    <div class="splide__track">
                                        <div class="splide__list" id="splideGranSuite">
                                            <a class="splide__slide" href="../img/granSuiteDeck.png">
                                                <img class="img-master-suite" src="../img/granSuiteDeck.png">
                                            </a>
                                            <a class="splide__slide" href="../img/granSuiteBano.png">
                                                <img class="img-master-suite" src="../img/granSuiteBano.png">
                                            </a>
                                            <a class="splide__slide" href="../img/granSuiteBath.png">
                                                <img class="img-master-suite" src="../img/granSuiteBath.png">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row row-img-master-suite mobile767">
                            <div class="col-12">
                                <div id="carouselGranSuite" class="carousel slide">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img src="../img/granSuiteDeck.png" class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="../img/granSuiteBaño.png" class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="../img/granSuiteBath.png" class="d-block w-100" alt="...">
                                        </div>
                                    </div>
        ...
        <section class="container">
            <div class="row rowSectionLocation">
                <div class="col-12">
                    ...
                    <a href="contacto.php" class="linkArrow"> <img src="../img/arrowRightGreen.svg" /></a>
                </div>
            </div>
        </section>
    </main>
