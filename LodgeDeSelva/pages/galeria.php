...
<head>
    ...
    <title>Galeria - La Misión Moconá</title>
                ...
                <div class="splide" id="splideSuiteDeSelvaGallery" aria-label="Splide Basic">
                    <div class="splide__track">
                        <div class="splide__list" id="splideSuiteDeSelva">
                            <a class="splide__slide" href="../img/deselva_01.png">
                                <img class="img-master-suite" src="../img/deselva_01.png">
                            </a>
                            <a class="splide__slide" href="../img/deselva_02.png">
                                <img class="img-master-suite" src="../img/deselva_02.png">
                            </a>
                            <a class="splide__slide" href="../img/deselva_03.png">
                                <img class="img-master-suite" src="../img/deselva_03.png">
                            </a>
                            <a class="splide__slide" href="../img/deselva_04.png">
                                <img class="img-master-suite" src="../img/deselva_04.png">
                            </a>
                            <a class="splide__slide" href="../img/deselva_05.png">
                                <img class="img-master-suite" src="../img/deselva_05.png">
                            </a>
                            <a class="splide__slide" href="../img/deselva_06.png">
                                <img class="img-master-suite" src="../img/deselva_06.png">
                            </a>
                            <a class="splide__slide" href="../img/deselva_07.png">
                                <img class="img-master-suite" src="../img/deselva_07.png">
                            </a>
                            <a class="splide__slide" href="../img/deselva_08.png">
                                <img class="img-master-suite" src="../img/deselva_08.png">
                            </a>
                            <a class="splide__slide" href="../img/deselva_09.png">
                                <img class="img-master-suite" src="../img/deselva_09.png">
                            </a>
                            <a class="splide__slide" href="../img/deselva_10.png">
                                <img class="img-master-suite" src="../img/deselva_10.png">
                            </a>
                            <a class="splide__slide" href="../img/deselva_11.png">
                                <img class="img-master-suite" src="../img/deselva_11.png">
                            </a>
                            <a class="splide__slide" href="../img/deselva_11.png">
                                <img class="img-master-suite" src="../img/deselva_11.png">
                            </a>
                ...
                <div class="splide" id="splideMasterSuite" aria-label="Splide Basic">
                    <div class="splide__track">
                        <div class="splide__list" id="splideMasterSuite">
                            <a class="splide__slide" href="../img/master_01.png">
                                <img class="img-master-suite" src="../img/master_01.png">
                            </a>
                            <a class="splide__slide" href="../img/master_02.png">
                                <img class="img-master-suite" src="../img/master_02.png">
                            </a>
                            <a class="splide__slide" href="../img/master_03.png">
                                <img class="img-master-suite" src="../img/master_03.png">
                            </a>
                            <a class="splide__slide" href="../img/master_04.png">
                                <img class="img-master-suite" src="../img/master_04.png">
                            </a>
                            <a class="splide__slide" href="../img/master_05.png">
                                <img class="img-master-suite" src="../img/master_05.png">
                            </a>
                            <a class="splide__slide" href="../img/master_06.png">
                                <img class="img-master-suite" src="../img/master_06.png">
                            </a>
                            <a class="splide__slide" href="../img/master_07.png">
                                <img class="img-master-suite" src="../img/master_07.png">
                            </a>
                            <a class="splide__slide" href="../img/master_08.png">
                                <img class="img-master-suite" src="../img/master_08.png">
                            </a>
                            <a class="splide__slide" href="../img/master_09.png">
                                <img class="img-master-suite" src="../img/master_09.png">
                            </a>
                            <a class="splide__slide" href="../img/master_10.png">
                                <img class="img-master-suite" src="../img/master_10.png">
                            </a>
                            <a class="splide__slide" href="../img/master_11.png">
                                <img class="img-master-suite" src="../img/master_11.png">
                            </a>
                            <a class="splide__slide" href="../img/master_12.png">
                                <img class="img-master-suite" src="../img/master_12.png">
                            </a>
                            <a class="splide__slide" href="../img/master_13.png">
                                <img class="img-master-suite" src="../img/master_13.png">
                            </a>
                            <a class="splide__slide" href="../img/master_14.png">
                                <img class="img-master-suite" src="../img/master_14.png">
                            </a>
                            <a class="splide__slide" href="../img/master_15.png">
                                <img class="img-master-suite" src="../img/master_15.png">
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="splide" id="splideGranSuite" aria-label="Splide Basic">
                    <div class="splide__track">
                        <div class="splide__list" id="splideGranSuite">
                            <a class="splide__slide" href="../img/gransuite_01.png">
                                <img class="img-master-suite" src="../img/gransuite_01.png">
                            </a>
                            <a class="splide__slide" href="../img/gransuite_02.png">
                                <img class="img-master-suite" src="../img/gransuite_02.png">
                            </a>
                            <a class="splide__slide" href="../img/gransuite_03.png">
                                <img class="img-master-suite" src="../img/gransuite_03.png">
                            </a>
                            <a class="splide__slide" href="../img/gransuite_04.png">
                                <img class="img-master-suite" src="../img/gransuite_04.png">
                            </a>
                        </div>
                    </div>
                </div>
