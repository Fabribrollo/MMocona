...
<body>
    ...
    <div class='div-ver-mas mobile767'><p class='p-verMas mobile767' id='ver-mas'>Ver más</p><img class='img-arrow-header mobile767' id='arrow-ver-mas' src='../img/arrowDownLightGreen.svg'>
    </div>";
    $rutaImagen = "'../img/sustentabilidad-header.png'";
    $classFlor = '';
                                ...
                                <div class="splide" id="splideSustentabilidadDiv" aria-label="Splide Sustentabilidad">
                                    <div class="splide__track">
                                        <div class="splide__list" id="splideSustentabilidad">
                                            <a class="splide__slide" href="../img/sustentabilidad1.png">
                                                <img class="img-master-suite" src="../img/sustentabilidad1.png">
                                            </a>
                                            <a class="splide__slide" href="../img/sustentabilidad2.png">
                                                <img class="img-master-suite" src="../img/sustentabilidad2.png">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="carouselMasterSuite" class="carousel slide">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img src="../img/sustentabilidad1.png" class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="../img/sustentabilidad2.png" class="d-block w-100" alt="...">
                                        </div>
                                    </div>
