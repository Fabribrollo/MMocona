    ...
    <header class="container-fluid header-index">
        <div class="container">
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                    <li class="nav-item dropdown">
                                        <a class="nav-link dropdown-toggle" id="habitaciones" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                            Habitaciones
                                        </a>
                                        <ul class="dropdown-menu">
                                            <li class="nav-item"><a class="dropdown-item nav-link" href="pages/domos.php#main-domos-rio">Domos Rio</a></li>
                                            <li class="nav-item"><a class="dropdown-item nav-link" href="pages/domos.php#main-domos-selva">Domos Selva</a></li>
                                        </ul>
                                    </li>
                                    <li class="nav-item dropdown">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="pages/gastronomia.php" id="restaurante">Restaurante</a>
                                    </li>
                                    <li class='nav-item'>
            ...
            <div class="row" id='row-header-title'>
                <div class="col-12">
                    <h6 class="page-name">LUXURY GLAMPING</h6>
                    <h1 class="title" id="header-vivi">Viví</h1>
        ...
        <section class="container">
            <div class="row justify-content-center">
                <div class='col-12 col-lg-11 col-form-reserva-ahora'>
                    <form class='form-reserva container-fluid form-reserva-ahora' action="https://www.hoteladmin.com.ar/system/responsive/plugged-apps/book-vertical.php?hotelID=334&action=query_externo" target="_blank"  method="post">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 colWithBorderRight">
                    ...
                    <div class="div-ver-mas-header">
                        ...
                        <img id='arrow-ver-mas' src="img/arrowDownYellow.svg" />
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6 order-0 order-lg-1 d-flex justify-content-center col-right-section-saltos">
                    ...
                    <div class="div-info-section-saltos">
                        ...
                        <a href="pages/saltos.php" class="linkArrow"> <img src="img/arrowRightYellow.svg" /></a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="container">
            <div class="row">
                <div class="col-12 col-lg-6 d-flex justify-content-center col-left-section-suite">
                    <h6 class="h6LaMision">LUXURY GLAMPING</h6>
                    <h3 class="h3TitleSection" id="domos-2">Domos</h3>
                    ...
                    <div class="div-info-section-saltos">
                        <a href="pages/domos.php" class="link" id="main-masInfo-2">Más información</a>
                        <a href="pages/domos.php" class="linkArrow"> <img src="img/arrowRightYellow.svg" /></a>
                    </div>
                </div>
                <div class="col-12 col-lg-6 text-center text-lg-start">
                    <img src="img/domo.png" class="img-saltos">
                </div>
            </div>
            <div class="row rowSectionLocation">
                <div class="col-12">
                    ...
                    <a href="pages/contacto.php" class="linkArrow"> <img src="img/arrowRightYellow.svg" /></a>
                </div>
            </div>
        </section>
    </main>
