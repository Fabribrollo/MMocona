...
<p class='p-header desktop767 p-header-second' id='main-p-padre-saltos-misiones'>El padre de los saltos de Misiones es el llamado por su descubridor “Gran Salto
    ...
    $rutaImagen = "'../img/saltosHeader.png'";
    $classFlor = '';
                                ...
                                <div class="splide" id="splideMoconaDiv" aria-label="Splide Basic">
                                    <div class="splide__track">
                                        <div class="splide__list" id="splideMocona">
                                            <a class="splide__slide" href="../img/mocona1.png">
                                                <img class="img-master-suite" src="../img/mocona1.png">
                                            </a>
                                            <a class="splide__slide" href="../img/mocona2.png">
                                                <img class="img-master-suite" src="../img/mocona2.png">
                                            </a>
                                            <a class="splide__slide" href="../img/mocona3.png">
                                                <img class="img-master-suite" src="../img/mocona3.png">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="carouselMasterSuite" class="carousel slide">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img src="../img/mocona1.png" class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="../img/mocona2.png" class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="../img/mocona3.png" class="d-block w-100" alt="...">
                                        </div>
                                    </div>
                                ...
                                <div class="splide" id="splideParaisoDiv" aria-label="Splide Basic">
                                    <div class="splide__track">
                                        <div class="splide__list" id="splideParaiso">
                                            <a class="splide__slide" href="../img/paraiso1.png">
                                                <img class="img-master-suite" src="../img/paraiso1.png">
                                            </a>
                                            <a class="splide__slide" href="../img/paraiso2.png">
                                                <img class="img-master-suite" src="../img/paraiso2.png">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row row-img-master-suite mobile767">
                            <div class="col-12">
                                <div id="carouselSuiteSelva" class="carousel slide">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img src="../img/paraiso1.png" class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="../img/paraiso2.png" class="d-block w-100" alt="...">
                                        </div>
                                    </div>
                            ...
                            <div class="splide" id="splideYerbasDiv" aria-label="Splide Basic">
                                <div class="splide__track">
                                    <div class="splide__list" id="splideYerbas">
                                        <a class="splide__slide" href="../img/yerbas.png">
                                            <img class="img-master-suite" src="../img/yerbas.png">
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row row-img-master-suite mobile767">
                        <div class="col-12">
                            <div id="carouselMasterSuite" class="carousel slide">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="../img/yerbas.png" class="d-block w-100" alt="...">
                                    </div>
                                </div>
                                <button class="carousel-control-prev" type="button" data-bs-target="#carouselMasterSuite" data-bs-slide="prev">
                                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
