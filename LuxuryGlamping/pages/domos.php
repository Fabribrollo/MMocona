...
<head>
    ...
    <title>Domos - Luxury Glamping</title>
...
<p class='p-header desktop767 p-header-second' id='p-header-second'>También podes hacer todas las actividades como safari en 4x4 por la selva,
    ...
    <div class='div-ver-mas mobile767'><p class='p-verMas mobile767' id='ver-mas'>Ver más</p><img class='img-arrow-header mobile767' id='arrow-ver-mas' src='../img/arrowDownLightYellow.svg'>
    </div>";
    $rutaImagen = "'../img/domo-header.png'";
    $classFlor = "";
        ...
        <section class="container">
            <div class="row">
                <div class="col-12 col-lg-7 col-with-border-bottom">
                    ...
                    <p class="p-suites" id="main-p-todos-los-domos">Todas los Domos poseen una única y exclusiva decoración.</p>
                                ...
                                <div class="splide" id="splideDomosRioDiv" aria-label="Splide Basic">
                                    <div class="splide__track">
                                        <div class="splide__list" id="splideDomosRio">
                                            <a class="splide__slide" href="../img/domoRio1.png">
                                                <img class="img-master-suite" src="../img/domoRio1.png">
                                            </a>
                                            <a class="splide__slide" href="../img/domoRio2.png">
                                                <img class="img-master-suite" src="../img/domoRio2.png">
                                            </a>
                                            <a class="splide__slide" href="../img/domoRio3.png">
                                                <img class="img-master-suite" src="../img/domoRio3.png">
                                            </a>
                                            <a class="splide__slide" href="../img/domoRio1.png">
                                                <img class="img-master-suite" src="../img/domoRio1.png">
                                            </a>
                                ...
                                <div id="carouselMasterSuite" class="carousel slide">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img src="../img/domoRio1.png" class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="../img/domoRio2.png" class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="../img/domoRio3.png" class="d-block w-100" alt="...">
                                        </div>
                                    </div>
                                ...
                                <div class="splide" id="splideDomosSelvaDiv" aria-label="Splide Basic HTML Example">
                                    <div class="splide__track">
                                        <div class="splide__list" id="splideDomosSelva">
                                            <a class="splide__slide" href="../img/domoSelva1.png">
                                                <img class="img-master-suite" src="../img/domoSelva1.png">
                                            </a>
                                            <a class="splide__slide" href="../img/domoSelva2.png">
                                                <img class="img-master-suite" src="../img/domoSelva2.png">
                                            </a>
                                            <a class="splide__slide" href="../img/domoSelva3.png">
                                                <img class="img-master-suite" src="../img/domoSelva3.png">
                                            </a>
                                            <a class="splide__slide" href="../img/domoSelva1.png">
                                                <img class="img-master-suite" src="../img/domoSelva1.png">
                                            </a>
                        ...
                        <div class="row row-img-master-suite mobile767">
                            <div class="col-12">
                                <div id="carouselSuiteSelva" class="carousel slide">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img src="../img/domoSelva1.png" class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="../img/domoSelva2.png" class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="../img/domoSelva3.png" class="d-block w-100" alt="...">
                                        </div>
                                    </div>
