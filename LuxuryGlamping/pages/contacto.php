...
<head>
    ...
    <title>Contacto - Luxury Glamping</title>
...
<body>
    ...
    $title = "Contacto";
    $contenidoHeader = "<div class='divContactSectionElLodge divContactSectionElLodgeContacto'>
    <img src='../img/whatsappMain.svg' class='imgContactSectionElLodge' /><span>(011) 15 3415- 0500
        /<br> (011) 15 5654-8388</span>
</div>
<div class='divContactSectionElLodge divContactSectionElLodgeContacto'>
    <img src='../img/mail.svg' class='imgContactSectionElLodge'><span>lamisionlodge@gmail.com</span>
</div>
<div class='divContactSectionElLodge divLocationSectionElLodge divContactSectionElLodgeContacto'>
    ...
    <span id='main-direccion'>Ruta provincial 2km 36.
        Colonia Paraíso -<br>Saltos del Moconá -
        Misiones - Argentina</span>
</div>";
    $rutaImagen = "'../img/headerContacto.png'";
        ...
        <section class="container">
            <div class="row rowSectionLocation">
                <div class="col-12">
                    ...
                    <a href="#" class="link" id="main-masInfo-1">Más información</a>
                    <a href="#" class="linkArrow"> <img src="../img/arrowRightYellow.svg" /></a>
                </div>
            </div>
        </section>
    </main>
