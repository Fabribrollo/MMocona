...
<head>
    ...
    <title>Gastronomía - La Misión Moconá</title>
...
<body>
    ...
    $title = "Gastronomía";
    $contenidoHeader = "<p class='p-header' id='header-p-restaurante-la-mision'>En el restaurant de La Misión proponemos disfrutar del placer de los mejores
    sabores elaborados con productos frescos y de la mejor calidad. La mayoría de las verduras y
    hortalizas son de nuestra huerta, lo cual nos permite disfrutar de los gustos naturales sin
    químicos ni conservantes</p>";
    $rutaImagen = "'../img/gastronomiaHeader.png'";
    $classFlor = '';
    headerPrint($title, $contenidoHeader, $rutaImagen, $classFlor);
    ?>
    <main class="container-fluid section-suites section-gastronomia">
        <section class="container">
            <div class="row">
                <div class="col-12 col-lg-7 col-with-border-bottom">
                    <p class="p-suites" id="main-p-nuestra-propuesta-gastronomica">Nuestra propuesta gastronómica puede variar a gusto de nuestros huéspedes pero
                        generalmente es un menú fijo que varía a lo largo de los días de la semana.
                        Nuestros panes, mermeladas y aperitivos son totalmente caseros y elaborados diariamente.
                        El desayuno, además de los sabores típicos ofrecemos: café, leche, te, mate, tostadas y pan
                        casero, jamón, queso, manteca, distintas mermeladas y dulces caseros, tortas y demás cosas que
                        lo sorprenderán.
                    </p>
                    <p class="p-suites" id="main-p-ofrecemos-menus-especiales">Ofrecemos también menús especiales para niños, vegetarianos y celíacos.</p>
                    <hr class="separador-section" />
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12">
                                <h3 class="h3-title-subsection" id="main-menu">Menú</h3>
                            </div>
                            <div class="col-12 col-sm-6">
                                <p class="p-menu" id="main-arrolladitos-acelga">Arrolladitos de acelga <br />
                                    Gigots de pollo con papas a la crema <br />
                                    Mousse chocolate
                                </p>
                                <p class="p-menu">-</p>
                                <p class="p-menu" id="main-pastel-choclo">Pastel de choclo <br />
                                    Lasaña de carne <br />
                                    Rogel
                                </p>
                                <p class="p-menu">-</p>
                                <p class="p-menu" id="main-zapallito-relleno">Zapallito relleno <br />
                                    Peceto a la pimienta con puré de papa <br />
                                    Manzanas asadas con membrillo
                                </p>
                                <p class="p-menu">-</p>
                                <p class="p-menu" id="main-tortilla-española">Tortilla española <br />
                                    Sorrentino con salsa de champiñones<br />
                                    Peras a la Borgoña
                                </p>
                            </div>
                            <div class="col-12 col-sm-6">
                                <p class="p-menu" id="main-ratatuile">Ratatuile <br />
                                    Pollo al romero con mandioca frita <br />
                                    Mamón en almibar
                                </p>
                                <p class="p-menu">-</p>
                                <p class="p-menu" id="main-budin-zapallito">Budín de zapallito <br />
                                    Colita cuadril mechada <br />
                                    Flan casero
                                </p>
                                <p class="p-menu">-</p>
                                <p class="p-menu" id="main-ensalada-griega">Ensalada griega <br />
                                    Fideos caseros cortados a cuchillo<br />
                                    Rogel
                                </p>
                            </div>
                        </div>
        ...
        <section class="container">
            <div class="row rowSectionLocation">
                <div class="col-12">
                    ...
                    <a href="contacto.php" class="linkArrow"> <img src="../img/arrowDownYellow.svg" /></a>
                </div>
            </div>
        </section>
    </main>
